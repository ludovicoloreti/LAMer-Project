...
class LoginViewController:UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
		...
		// Centro la loading all'interno del bottone "Continua" copiando incollando le prossime 2 righe di codice
		activityView.frame = CGRect(x: 0, y: 0, width: 200, height: 50)
        activityView.center = CGPoint(x: view.center.x, y: view.frame.height - continueButton.frame.height - 24)
